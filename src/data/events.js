...
export const eventGroups = [
  {
    ...
    events: [
      { id: 1, title: 'Global Tech Summit 2026', date: 'Oct 15 - 17, 2026', location: 'ICT Faculty, Mahidol University', totalSpots: 100, filledSpots: 58, capacity: '42 spots remaining', image: techSummitImage, status: 'open', badge: 'Open' },
      { id: 2, title: 'UX Design Leadership Retreat', date: 'Sep 02, 2026', location: 'Austin, TX', totalSpots: 100, filledSpots: 95, capacity: 'Only 5 spots remaining!', image: designRetreatImage, status: 'almost-full', badge: 'Almost full' },
